    ...
    <div className="min-h-screen bg-pink-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-playfair text-2xl font-bold text-pink-900 mb-2">Admin Login</h1>
          <p className="text-pink-600/70 text-sm">Silakan masukkan password untuk masuk</p>
        </div>
