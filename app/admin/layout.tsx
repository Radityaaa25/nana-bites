...
import { LayoutDashboard, UtensilsCrossed, Package, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-pink-50/50 flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex w-64 flex-col bg-white border-r border-pink-100 p-6 sticky top-0 h-screen">
        <div className="flex items-center gap-2 mb-10">
          ...
          <span className="font-playfair text-xl font-bold text-pink-700">Admin Bites</span>
        </div>
        ...
        <button 
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-xl text-red-500 hover:bg-red-50 transition-colors font-medium text-sm mt-auto"
        >
